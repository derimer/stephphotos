 ...
 function Testimonials() {
  return (
    <section id="Testimonials">
      ...
      Pas de tatonnement  ni d'hésitation. On se trouve naturellement ou il faut,<br/>
      on lève l'appareil à l'oeil, le cadre et le point se font tout seuls, on déclenche,
      ...
      suggérait déja dans son nom la pratique cursive de la photographie,<br/>
      ...
      voués à l'oubli instantanné(c'est le progrès).<br/>
